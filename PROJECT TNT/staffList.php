 ...
 <?php include("CHeader.php")?>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '</td>';
            echo '<td style="vertical-align: middle;">';
            echo '<button class="btn btn-tertiary me-2" onclick="location.href=\'updateStaffInfo.php?id=' . $row["staffID"] . '\'"><img src="images/edit.png"></button>';
            echo '<button class="btn btn-tertiary me-2" onclick="location.href=\'deleteStaff.php?id=' . $row["staffID"] . '\'"><img src="images/delete.png"></button>';
            echo '</td>';
            echo '</tr>';
            echo '</tbody>';
            echo '</table>';
