    ...
    <div class="container">
        ...
        <div class="main-content">
            <div class="tracking-container">
                ...
                <div>
                    <input type="text" placeholder="TRK2024FKL123" >
                    <button>SAVE</button>
                </div>
            </div>
            <div class="details-container">
                ...
                <div class="details">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td class="date">11/03/2024</td>
                                <td class="info">Delivered<br>Recipient: Siti Sarah Zainab</td>
                            </tr>
                            <tr>
                                <td class="date">11/03/2024</td>
                                <td class="info">Out for delivery</td>
                            </tr>
                            <tr>
                                <td class="date">10/03/2024</td>
                                <td class="info">Arrived at delivery hub<br>Branch: Terengganu Hub</td>
                            </tr>
                            <tr>
                                <td class="date">10/03/2024</td>
                                <td class="info">Departed from sorting centre<br>Destination: TGG Sorting Centre</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
